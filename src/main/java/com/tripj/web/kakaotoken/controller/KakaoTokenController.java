package com.tripj.web.kakaotoken.controller;

import com.tripj.global.error.exception.Custom404Exception;
import com.tripj.global.util.EnvironmentUtil;
import com.tripj.web.kakaotoken.client.KakaoTokenClient;
import com.tripj.web.kakaotoken.dto.KakaoTokenDto;
import com.tripj.web.kakaotoken.util.KakaoApiUtil;
...
//        String serviceURL = ServletRequestUtil.getServiceURL(request);
        ...
        // 결과를 처리할 URI 정보
        String redirectUri = "http://localhost/oauth/kakao/callback";
    ...
    public @ResponseBody String loginCallback(String code) {
        ...
        KakaoTokenDto.Request kakaoTokenRequestDto = KakaoTokenDto.Request.builder()
                ...
                .code(code)
                .redirect_uri("http://localhost/oauth/kakao/callback")
                .build();
